                                                            ...
                                                            <div class="tab-content">
                                                                <div class="tab-pane show active" id="input-types-preview">
                                                                    <div class="row">
                                                                         ...
                                                                         <form action="servlet_libro" method="post">
                                                                                
                                                                                <div class="">
                                                                                    <div class="block">
                                                                                        <label for="simpleinput" class="form-label">idLibro</label>
                                                                                        <input type="text" id="simpleinput" name="idlibro" class="form-control">
                                                                                    </div>

                                                                                    <div class="block">
                                                                                        <label for="simpleinput" class="form-label">Autor</label>
                                                                                        <input type="text" id="simpleinput" name="autor" class="form-control">
                                                                                    </div>
                                                                                    
                                                                                    <div class="block">
                                                                                        <label for="simpleinput" class="form-label">Edicion</label>
                                                                                        <input type="text" id="simpleinput" name="edicion" class="form-control">
                                                                                    </div>
                                                                                    
                                                                                     <div class="block">
                                                                                        <label for="simpleinput" class="form-label">Año Publicacion</label>
                                                                                        <input type="text" id="simpleinput" name="publicacion" class="form-control">
                                                                                    </div>
                                                                                ...
                                                                                <div class="">
                                                                                    ...
                                                                                    <div class="block">
                                                                                        ...
                                                                                        <input type="text" id="simpleinput" name="titulo" class="form-control">
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="block">
                                                                                        <label for="simpleinput" class="form-label">Pais</label>
                                                                                        <input type="text" id="simpleinput" name="pais" class="form-control">
                                                                                    </div>
                                                                                    
                                                                                    <div class="block">
                                                                                        <label for="simpleinput" class="form-label">Editoria</label>
                                                                                        <input type="text" id="simpleinput" name="editorial" class="form-control">
                                                                                    </div>
                                                                                ...
                                                                                <div class="">
                                                                                     ...
                                                                                     <div class="block">
                                                                                        <label for="simpleinput" class="form-label">Paginas</label>
                                                                                        <input type="text" id="simpleinput" name="paginas" class="form-control">
                                                                                    </div>
                                                                                    
                                                                                    <div class="block">
                                                                                        <label for="simpleinput" class="form-label">ISBN</label>
                                                                                        <input type="text" id="simpleinput" name="isbn" class="form-control">
                                                                                    </div>
                                                                                    
                                                                                     <div class="block">
                                                                                        <label for="simpleinput" class="form-label">Estado</label>
                                                                                        <input type="text" id="simpleinput" name="estado" class="form-control">
                                                                                    </div>
                                                                                    
                                                                                    <div class="block">
                                                                                        <label for="simpleinput" class="form-label">ejemplares</label>
                                                                                        <input type="text" id="simpleinput" name="ejemplares" class="form-control">
                                                                                    </div>
                                                                                ...
                                                                                <div class="">
                                                                                    ...
                                                                                    <div class="block">
                                                                                        <label for="example-select" class="form-label">CD</label>
                                                                                        <select class="form-select" id="example-select" name="cd">
                                                                                      ...
                                                                                      <div class="block">
                                                                                        <label for="simpleinput" class="form-label">Tipo</label>
                                                                                        <input type="text" id="simpleinput" name="tipo" class="form-control">
                                                                                    </div>
                                                                                    
                                                                                    <div class="block">
                                                                                        <label for="simpleinput" class="form-label">vigencia</label>
                                                                                        <input type="gmail" id="simpleinput" name="vigencia" class="form-control">
                                                                                    </div>

                                                                                      <div class="block">
                                                                                        <label for="simpleinput" class="form-label">idCarrera</label>
                                                                                        <input type="gmail" id="simpleinput" name="idcarrera" class="form-control">
                                                                                    </div>
                                                                                </div>
