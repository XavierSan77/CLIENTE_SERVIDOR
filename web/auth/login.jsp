                    ...
                    <div class="card-body">
                        ...
                        <form action="NewServletUno">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="email" id="txtUsu" required="" placeholder="Ingrese su Usuario" value="" >
                            </div>
                            <div class="mb-3">
                                <label for="password" class="form-label">Contraseña</label>
                                <input class="form-control" type="password" required="" id="txtPass" placeholder="Ingrese su Contraseña" value="">
                            </div>
                            <div class="mb-3">
